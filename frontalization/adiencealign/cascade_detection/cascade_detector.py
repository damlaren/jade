...
class CascadeDetector(object):
    ...
    '''
    def __init__(self, cascade_file = '/home/albert/Desktop/frontalization/adience_align-master/adiencealign/resources/haarcascade_frontalface_default.xml', 
                 min_size = (10, 10),
                 min_neighbors = 20,
                 scale_factor = 1.04,
                 angles = [0],
    ...
    def detectMultiScaleWithScores(self, img, scaleFactor = None, minNeighbors = None, minSize = None, flags = 4):
        ...
        faces = self._cascade_classifier.detectMultiScale(img, 
